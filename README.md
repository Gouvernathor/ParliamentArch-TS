...
- [`@parliamentarch/svg`](./packages/svg) uses `core` in order to generate SVG files or DOM nodes. However, it doesn't work without either being used in a browser, or having an emulator of the DOM functions (such as [jsdom](https://www.npmjs.com/package/jsdom)) in Node.js.
